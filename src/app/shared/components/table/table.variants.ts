...
export const tableRowVariants = cva('border-b transition-colors hover:bg-accent data-[state=selected]:bg-muted', {
  variants: {},
  defaultVariants: {},
});
