export const esTranslations = {
  ...
  'stock_adjustments_description': 'Gestiona los ajustes de inventario para mantener el stock actualizado',
  'new_stock_adjustment': 'Nuevo Ajuste de Stock',
  ...
  'submitting': 'Enviando...',
  'stock_adjustment_created_successfully': 'Ajuste de stock creado exitosamente',
  'failed_to_create_stock_adjustment': 'Error al crear el ajuste de stock',
  'error_loading_adjustments': 'Error al cargar los ajustes',
  'no_adjustments_found': 'No se encontraron ajustes',
  'no_adjustments_description': 'No hay ajustes de stock registrados aún',
  ...
  'STOCK_ALERTS.WIDGET_TITLE': 'Alertas de Stock',
  ...
  'STOCK_ALERTS.CURRENT_STOCK': 'Stock Actual',
  'STOCK_ALERTS.RECOMMENDED_STOCK': 'Stock Recomendado',
  ...
  'STOCK_ALERTS.LOW_STOCK': 'Stock bajo',
