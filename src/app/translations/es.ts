export const esTranslations = {
  ...
  'user_management.create_user_description': 'Registra un nuevo usuario en el sistema',
  ...
  'roles.full_access_message': 'Este rol tiene acceso total a todas las funciones.',
  ...
  'advanced_filters_description': 'Crea filtros personalizados para refinar tu búsqueda',
  'no_filters_added': 'No hay filtros agregados. Haz clic en "Agregar Filtro" para comenzar.',
  ...
  'create_location_description': 'Registra una nueva ubicación (pallet, estante, contenedor, etc.) en el almacén.',
  ...
  'location_types_management_description': 'Administra los tipos de ubicación (Pallet, Estante, Contenedor, etc.) usados al crear ubicaciones.',
  'create_location_type': 'Crear Tipo de Ubicación',
  'edit_location_type': 'Editar Tipo de Ubicación',
  'create_location_type_description': 'Agregar un nuevo tipo de ubicación al catálogo.',
  'edit_location_type_description': 'Actualizar el tipo de ubicación seleccionado.',
  ...
  'delete_location_type_confirm': '¿Estás seguro de que deseas eliminar este tipo de ubicación?',
  'set_location_type_order': 'Establecer orden',
  'set_location_type_order_description': 'Usa las flechas para definir el orden de visualización de los tipos de ubicación.',
  'move_up': 'Subir',
  'move_down': 'Bajar',
  ...
  'add_inventory_entry_description': 'Agregar una nueva entrada de inventario con SKU, ubicación y cantidad.',
  'edit_inventory_item': 'Editar Producto',
  'edit_inventory_item_description': 'Actualizar la entrada de inventario seleccionada.',
  ...
  'tracking_options_help': 'Haz clic en una tarjeta para activarla (verde); haz clic de nuevo para desactivarla.',
  ...
  'add': 'Agregar',
  'serials_help_add': 'Escribe un número de serie y presiona Enter o haz clic en “Agregar”.',
  'serials_placeholder': 'Ej: SN-000123',
  'serials_added': 'Series agregadas',
  'serials_remaining_prefix': 'Faltan',
  'lots_help_add': 'Escribe un número de lote y presiona Enter o haz clic en "Agregar".',
  ...
  'create_article_description': 'Crear un nuevo artículo con datos de producto e inventario',
  ...
  'sku_already_exists': 'El código SKU ya está registrado. Por favor, utilice otro código.',
  ...
  'create_picking_task_description': 'Registra una nueva tarea de alisto con documento, operador, artículos y ubicaciones.',
  'edit_picking_task': 'Editar Tarea de Alisto',
  'edit_picking_task_description': 'Modifica los datos de la tarea de alisto seleccionada.',
  ...
  'items_to_pick_description': 'Agrega los artículos con SKU, cantidad y ubicación para cada ítem.',
