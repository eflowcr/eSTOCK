export const enTranslations = {
  ...
  'user_management.create_user_description': 'Register a new user in the system',
  ...
  'add_inventory_entry_description': 'Add a new inventory entry with SKU, location, and quantity.',
  ...
  'create_location_description': 'Register a new location (pallet, shelf, bin, etc.) in the warehouse.',
  ...
  'location_types_management_description': 'Manage location types (Pallet, Shelf, Bin, etc.) used when creating locations.',
  ...
  'delete_location_type_confirm': 'Are you sure you want to delete this location type?',
  'set_location_type_order': 'Set order',
  'set_location_type_order_description': 'Drag the list or use the arrows to set the display order of location types.',
  'move_up': 'Move up',
  'move_down': 'Move down',
