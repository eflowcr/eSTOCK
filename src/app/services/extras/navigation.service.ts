...
const ALL_NAV_ITEMS: NavigationItems = [
  ...
  { name: 'sales_orders', href: '/sales-orders', icon: 'ShoppingCart', permission: { resource: 'sales_orders', action: 'read' } },
  ...
  { name: 'purchase_orders', href: '/purchase-orders', icon: 'ShoppingCart', permission: { resource: 'purchase_orders', action: 'read' } },
  // Inventory
